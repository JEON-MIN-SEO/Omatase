...
import Omatase.omatase.service.AdminJoinService;
...
public class JoinAPI {
    ...
    public JoinAPI(JoinService joinService, AdminJoinService adminJoinService) {
        this.joinService = joinService;
        this.adminJoinService = adminJoinService;
    }
